...
const StaffComplateJob = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <ScrollView
      style={[styles.staffComplateJob, styles.vectorIcon3Layout]}
      showsVerticalScrollIndicator={false}
      showsHorizontalScrollIndicator={false}
      contentContainerStyle={styles.staffComplateJobScrollViewContent}
    >
      ...
      <View style={styles.content}>
        ...
        <View style={[styles.view1, styles.viewSpaceBlock]}>
          <View style={[styles.typetem, styles.typetemShadowBox]}>
            ...
            <View style={[styles.buttonParent, styles.typetemParentSpaceBlock]}>
          ...
          <View style={[styles.typetem1, styles.typetemParentSpaceBlock]}>
            ...
            <View
              style={[styles.eplocationParent, styles.typetemParentSpaceBlock]}
            >
          ...
          <View style={[styles.typetem2, styles.typetemParentSpaceBlock]}>
            ...
            <Text style={[styles.barTendersStock, styles.barClr]}>
              Buzzy pub with retro, gin palace-inspired decor, plus regular live
              music and DJs.
            </Text>
          </View>
        </View>
      ...
      <View style={styles.view2}>
        ...
        >
          <Text style={[styles.login, styles.loginTypo]}>Complete Job</Text>
        </Pressable>
      </View>
    </ScrollView>
  );
...
const styles = StyleSheet.create({
  staffComplateJobScrollViewContent: {
...
export default StaffComplateJob;
